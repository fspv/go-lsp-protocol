...
import (
	...
	"github.com/fspv/go-lsp-protocol/internal/protocol/command/commandmeta"
	"github.com/fspv/go-lsp-protocol/internal/imports"
)
...
func Generate() ([]byte, error) {
	...
	const thispkg = "github.com/fspv/go-lsp-protocol/internal/protocol/command"
	...
	d := data{
		...
		Imports: map[string]bool{
			"context": true,
			"fmt":     true,
			"github.com/fspv/go-lsp-protocol/internal/protocol": true,
		},
	}
